...
plot_contours(ax, model, xx, yy, cmap='coolwarm', alpha=0.5)
# ax.scatter(X0, X1, c=y, cmap='coolwarm', s=50, edgecolors='k')

plt.scatter(df0['sepal length (cm)'], df0['sepal width (cm)'], color='b', marker ='o')
plt.scatter(df1['sepal length (cm)'], df1['sepal width (cm)'], color='y', marker ='o')
plt.scatter(df2['sepal length (cm)'], df2['sepal width (cm)'], color='r', marker ='o')
plt.grid(True)
